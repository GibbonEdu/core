    ...
    (function () {
        class TabPanel {
            ...
            initTab() {
                ...
                var de = this.tabList.querySelector('[aria-selected="true"]'), d = Util.getIndexInArray(this.triggers, de);
            ...
            selectNewTab(t) {
                var e = this.tabList.querySelector('[aria-selected="true"]'), s = Util.getIndexInArray(this.triggers, e);
            ...
            initDeepLink() {
                if (this.deepLinkOn) {
                    var t = window.location.hash.substr(1), e = this;
                    if (t && "" != t)
        ...
        class Schedule {
            constructor(t) {
                var s, e;
                var ee = document.getElementsByClassName("js-tabs");
                if (0 < ee.length) for (var se = 0; se < ee.length; se++) new TabPanel(ee[se]);

                (this.options = Util.extend(Schedule.defaults, t)),
                    ...
                    ((s.modalContent = s.modal[0].getElementsByClassName("js-w-schedule-modal__content")[0]),
                        ...
                        s.modal[0].addEventListener("modalIsOpen", function (t) {
                            ...
                            (s.target = t.detail.closest('[aria-controls="' + s.modalId + '"]')),
                                (function (a, o) {
                                    if (f) return o();
                                    var t = a.target.getBoundingClientRect(), e = a.modalContent.getBoundingClientRect(), r = e.left - t.left, d = e.top - t.top, h = t.width / e.width, c = t.height / e.height, u = null, m = a.animationDuration;
                                    ...
                                    var g = function (t) {
                                        ...
                                        var e = t - u;
                                        m < e && (e = m);
                                        var s = Math.easeOutQuart(e, h, 1 - h, m), i = Math.easeOutQuart(e, c, 1 - c, m), l = Math.easeOutQuart(e, 0, r, m), n = Math.easeOutQuart(e, 0, d, m);
        ...
        (window.WSchedule = Schedule).defaults = { element: "", searchData: !1 };
