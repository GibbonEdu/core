...
if ($el->isHouseLogo) { //Spacing with house logo
	...
	<div class="ui-tooltip-content">
		<div style='font-weight: bold; font-style: italic; font-size: 120%; margin-top: 10px; margin-bottom: 15px; padding-bottom: 15px; border-bottom: 1px dotted rgba(255,255,255,0.5); display: block'><?php echo $this->__('New Messages'); ?></div><?php
		...
		if (count($el->output)>3) { ?>
			<em><?php echo $this->__( 'Plus more'); ?>...</em><?php
		} ?>
	</div>
	<div style='text-align: right; margin-top: 20px; color: #666'>
		<a onclick='$("#messageBubble").hide("fade", {}, 1); $("#messageBubbleArrow").hide("fade", {}, 1)' style='text-decoration: none; color: #666' href='<?php echo $el->URL; ?>'><?php echo $this->__('Read All'); ?></a>
		<a style='text-decoration: none; color: #666' onclick='$("#messageBubble").hide("fade", {}, 1000); $("#messageBubbleArrow").hide("fade", {}, 1000)' href='#'><?php echo $this->__('Dismiss'); ?></a>
	</div>
</div><?php
