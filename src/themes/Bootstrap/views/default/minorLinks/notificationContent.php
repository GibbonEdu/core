...
if ($this->session->isEmpty('gibbonPersonID')) {
 ...
 . <a title="<?php echo $this->__('Notifications'); ?>" href="<?php echo GIBBON_URL; ?>index.php?q=/notifications.php"><?php echo count($notifications); ?> x <?php echo $this->renderReturn('default.minorLinks.notification_on'); ?></a><?php
	}
	else { ?>
