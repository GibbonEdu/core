...
?>
<div id="footer">
    <?php print trans::__( "Powered by") ?> <a target='_blank' href="https://gibbonedu.org">Gibbon</a> v<?php print $this->config->get('version') ?><?php if ($this->session->get("cuttingEdgeCode")=="Y") { print "-dev" ; }?> | &#169; <a target='_blank' href="http://rossparker.org">Ross Parker</a> 2010-<?php print date("Y") ?><br/>
    <span style='font-size: 90%; '>
        <?php print trans::__( "Created under the") ?> <a target='_blank' href="https://www.gnu.org/licenses/gpl.html">GNU GPL</a> at <a target='_blank' href='http://www.ichk.edu.hk'>ICHK</a> | <a target='_blank' href='https://gibbonedu.org/contribute/'><?php print trans::__( "Credits") ; ?></a><br/>
        <?php
            $seperator=FALSE ;
            $thirdLine=FALSE ;
            if ($this->session->notEmpty("i18n.maintainerName") AND $this->session->get("i18n.maintainerName")!="Gibbon") {
                if ($this->session->notEmpty("i18n.maintainerWebsite")) {
                    echo trans::__('Translation led by %1$s', array(" <a target='_blank' href='" . $this->session->get("i18n.maintainerWebsite") . "'>" . $this->session->get("i18n.maintainerName") . "</a>")) ;
                }
                else {
                    echo trans::__('Translation led by %1$s', array(" " . $this->session->get("i18n.maintainerName"))) ;
                }
                $seperator=TRUE ;
                $thirdLine=TRUE ;
            }
