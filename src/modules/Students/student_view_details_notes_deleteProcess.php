...
$URL = $_SESSION['absoluteURL'].'/index.php?q=/modules/'.getModuleName($_POST['address'])."/student_view_details_notes_delete.php&gibbonPersonID=$personID&search=".$_GET['search']."&subpage=$subpage&gibbonStudentNoteID=".$noteID.'&category='.$_GET['category']."&allStudents=$allStudents";
$URLDelete = $_SESSION['absoluteURL'].'/index.php?q=/modules/'.getModuleName($_POST['address'])."/student_view_details.php&gibbonPersonID=$personID&search=".$_GET['search']."&subpage=$subpage&category=".$_GET['category']."&allStudents=$allStudents";
