 ...
 * @since   v21
 */
class INPersonDescriptorGateway extends QueryableGateway implements ScrubbableGateway
{
    use TableAware;
    use Scrubbable;
    use ScrubByPerson;

    private static $tableName = 'gibbonINPersonDescriptor';
    private static $primaryKey = 'gibbonINPersonDescriptorID';
