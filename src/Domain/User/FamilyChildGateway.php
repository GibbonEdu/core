...
class FamilyChildGateway extends QueryableGateway implements ScrubbableGateway
{
    ...
    public function selectChildrenByFamilyAdult($gibbonFamilyID,$gibbonSchoolYearID, $gibbonPersonID)
    {
        $data = ['gibbonFamilyID' => $gibbonFamilyID, 'gibbonSchoolYearID' => $gibbonSchoolYearID, 'gibbonPersonID' => $gibbonPersonID];
    ...
    public function getChildInfoByFamilyAdult($gibbonPersonID, $gibbonPersonID2)
    {
        $data = ['gibbonPersonID' => $gibbonPersonID, 'gibbonPersonID2' => $gibbonPersonID2, 'date' => date('Y-m-d')];
