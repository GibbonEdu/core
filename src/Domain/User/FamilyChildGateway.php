...
class FamilyChildGateway extends QueryableGateway implements ScrubbableGateway
{
    ...
    public function selectStudentByFamilyID($gibbonFamilyID, $gibbonSchoolYearID) 
    {
        $data = ['gibbonFamilyID' => $gibbonFamilyID, 'gibbonSchoolYearID' => $gibbonSchoolYearID];
    ...
    public function selectStudentByAdultID($gibbonPersonID, $gibbonPersonID2)
    {
