...
class UserGateway extends QueryableGateway implements ScrubbableGateway
{
     ...
     * @return DataSet
     */
    public function queryAllUsers(QueryCriteria $criteria, $gibbonPersonTutorID = false)
    {
        $query = $this
            ->newQuery()
        ...
        if ($gibbonPersonTutorID) { //GS//
            $query->innerJoin('gibbonStudentEnrolment', 'gibbonPerson.gibbonPersonID=gibbonStudentEnrolment.gibbonPersonID') //GS//
                  ->innerJoin('gibbonFormGroup', 'gibbonStudentEnrolment.gibbonFormGroupID=gibbonFormGroup.gibbonFormGroupID') //GS//
                  ->where("gibbonFormGroup.gibbonPersonIDTutor = '".$gibbonPersonTutorID."'")
                  ->where("gibbonStudentEnrolment.gibbonStudentEnrolmentID IS NOT NULL")
