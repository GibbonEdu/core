...
require_once GIBBON_ROOT.'vendor/phpoffice/phpexcel/Classes/PHPExcel.php';
...
class Excel extends \PHPExcel
{
	 ...
	 * @param	string	$excel_file_name	File Name
	 * @return	string	Export to Browser.
	 */
	function exportWithQuery($qry, $excel_file_name)
	{
		$body = NULL ;
		$tmprst = $this->view->pdo->query($qry);
	...
	{
		$this->getProperties()->setCreator($this->view->__("Gibbon Edu using PHPExcel"));
		$this->getProperties()->setLastModifiedBy($this->view->__("Gibbon"));
		$this->getProperties()->setTitle($this->view->__("Office 2007 XLSX Test Document"));
		$this->getProperties()->setSubject($this->view->__("Office 2007 XLSX Test Document"));
		$this->getProperties()->setDescription($this->view->__('This information is confidential. Generated by Gibbon (https://gibbonedu.org).'));
	 ...
	 * @return	void
	 */
	public function __construct(view $view, $fileName = NULL)
	{
		parent::__construct();
		$this->view = $view;
