...
<?php } elseif ($type == 'input') { ?>
    ...
    <input type="<?= $type; ?>" <?= $attributes; ?> class="<?= $class; ?> <?= $groupClass; ?> items-center border border-gray-500 px-8 py-2 text-sm font-semibold shadow-sm text-gray-800 hover:bg-gray-200 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-500 bg-gray-100"/>
