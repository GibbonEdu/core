...
class StudentDashboard implements OutputableInterface
{
    ...
    protected function renderDashboard()
    {
        ...
        //GET TIMETABLE
        $timetable = false;
        if (isActionAccessible($guid, $connection2, '/modules/Timetable/tt.php') and $session->get('username') != '' and getRoleCategory($session->get('gibbonRoleIDCurrent'), $connection2) == 'Student') {
