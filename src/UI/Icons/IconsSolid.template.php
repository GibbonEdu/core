...
$icons = [
    ...
    // Heroicons: addmultiple' || $icon == 'add-multi' || $icon == 'page_new_multi
    'addmultiple' => <<<HTML
    <svg class="{$class}" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
    ...
    // Heroicons: external-link' || $icon == 'arrow-top-right-on-square
    'external-link' => <<<HTML

    <svg class="{$class}" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" aria-hidden="true">
    <path stroke-linecap="round" stroke-linejoin="round" d="M13.5 6H5.25A2.25 2.25 0 0 0 3 8.25v10.5A2.25 2.25 0 0 0 5.25 21h10.5A2.25 2.25 0 0 0 18 18.75V10.5m-10.5 6L21 3m0 0h-5.25M21 3v5.25" />
    </svg>
    HTML,


    // Heroicons: print' || $icon == 'print
    'print' => <<<HTML
    <svg class="{$class}" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
    ...
    // Heroicons: export' || $icon == 'download
    'export' => <<<HTML
    <svg class="{$class}" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
    ...
    // Heroicons: import' || $icon == 'upload' || $icon == 'page_up
    'import' => <<<HTML
    <svg class="{$class}" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
    ...
    // Heroicons: accept' || $icon == 'icontick' || $icon == 'check
    'accept' => <<<HTML
    <svg class="{$class}" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
    ...
    // Heroicons: reject' || $icon == 'iconcross' || $icon == 'cross
    'reject' => <<<HTML
    <svg class="{$class}" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
    ...
    // Heroicons: arrow-right-circle' || $icon == 'page_right' || $icon == 'copyforward
    ...
    // Heroicons: arrow-left-circle' || $icon == 'page_left' || $icon == 'copyback
    ...
    'arrow-down-on-square-stack' => <<<HTML
    <svg class="{$class}" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
    ...
    // Heroicons: profile' || $icon == 'profile
    'profile' => <<<HTML
    <svg class="{$class}" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
    ...
    // Heroicons: users' || $icon == 'meet the teacher
    'users' => <<<HTML
    <svg class="{$class}" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
    ...
    // Heroicons: user-group' || $icon == 'attendance
    'user-group' => <<<HTML
    <svg class="{$class}" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
    ...
    // Heroicons: warning' || $icon == 'exclamation-triangle
    'warning' => <<<HTML
    <svg class="{$class}" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
    ...
    // Heroicons: trophy' || $icon == 'house points
    'trophy' => <<<HTML
    <svg class="{$class}" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
    ...
    // Heroicons: share' || $icon == 'free learning
    'share' => <<<HTML
    <svg class="{$class}" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
    ...
    // Heroicons: link' || $icon == 'staff information' or $icon == 'student information' or $icon == 'parent information
    'link' => <<<HTML
    ...
    // Heroicons: markbook' || $icon == 'rubric
    'markbook' => <<<HTML
    <svg class="{$class}" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
    ...
    // Heroicons: document' || $icon == 'internal-assessment
    'document' => <<<HTML
    <svg class="{$class}" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
    ...
    // Heroicons: refresh' || $icon == 'refresh
    'refresh' => <<<HTML
    <svg class="{$class}" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
    ...
    // Heroicons: security' || $icon == 'access
    'security' => <<<HTML
    <svg class="{$class}" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
    ...
    // Heroicons: unfavourite' || $icon == 'unbookmark
    'unfavourite' => <<<HTML
    <svg class="{$class}" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
    ...
    // Heroicons: favourite' || $icon == 'bookmark
    'favourite' => <<<HTML
    <svg class="{$class}" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
    ...
    // Heroicons: book-open' || $icon == 'planner
    'book-open' => <<<HTML
...
$icons['alias'] = [
    ...
    'iconcross'                 => 'reject',
    'cross'                     => 'reject',
    'page_right'                => 'arrow-right-circle',
    'copyforward'               => 'arrow-right-circle',
    'page_left'                 => 'arrow-left-circle',
    'copyback'                  => 'arrow-left-circle',
    'quicksave'                 => 'archive',
    'delivery2'                 => 'archive',
    'run'                       => 'config',
