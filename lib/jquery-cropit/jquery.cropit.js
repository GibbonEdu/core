	...
	var Cropit = (function () {
	  ...
	  _createClass(Cropit, [{
	      ...
	      if (file && file.type.match('image')) {
	        ...
	        if (iOS) {
				...
				switch (this.exifdata.Orientation) {
				    case 8:
			           _this.exifRotation = 270;
			           break;
			       case 3:
			           _this.exifRotation = 180;
			           break;
			       case 6:
			           _this.exifRotation = 90;
			           break;
			       }
				});
		    }
	    ...
	    value: function getCroppedImageData(exportOptions) {
	      ...
	      var iOS = /iPad|iPhone|iPod/.test(navigator.userAgent) && !window.MSStream;
	      if (iOS && this.exifRotation != 0) {
	      	this.rotation = (this.rotation + this.exifRotation) % 360;
	      }
