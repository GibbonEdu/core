									...
									print "<div class='minorLinks'>" ;
										...
										if (isset($_SESSION[$guid]["likeCount"])) {
											if ($_SESSION[$guid]["likeCount"]>0) {
												print " . <a title='" . substr($_SESSION[$guid]["likeCountTitle"],0,-2) . "' href='" . $_SESSION[$guid]["absoluteURL"] . "/index.php?q=stars.php'>" . $_SESSION[$guid]["likeCount"] . " x <img style='opacity: 0.8; vertical-align: -60%' src='" . $_SESSION[$guid]["absoluteURL"] . "/themes/" . $_SESSION[$guid]["gibbonThemeName"] . "/img/like_on.png'></a>" ;
											}
											else {
												print " . " . $_SESSION[$guid]["likeCount"] . " x <img title='" . substr($_SESSION[$guid]["likeCountTitle"],0,-2) . "' style='opacity: 0.8; vertical-align: -60%' src='" . $_SESSION[$guid]["absoluteURL"] . "/themes/" . $_SESSION[$guid]["gibbonThemeName"] . "/img/like_off.png'>" ;
											}
										}
										...
										if ($count>0) {
											...
											for ($i=0; $i<$count; $i++) {
												...
												print "<div style='margin-bottom: 30px; margin-left: 1%; float: left; width: 83%'>" ;
														...
														if ($result->rowCount()>0) {
															...
															print "<table cellspacing='0' style='margin: 3px 0px; width: 100%'>" ;
																print "<tr class='head'>" ;
																	...
																	print "<th>" ;
																		print _("Lesson") . "<br/>" ;
																		print "<span style='font-size: 85%; font-weight: normal; font-style: italic'>" . _("Summary") . "</span>" ;
																	print "</th>" ;
																	print "<th>" ;
																		print _("Homework") ;
																	print "</th>" ;
																	...
																	print "<tr class=$rowNum>" ;
																		...
																		print "<td>" ;
																			...
																			if (isset($unit[0])) {
																				print $unit[0] ;
																				if ($unit[1]!="") {
																					print "<br/><i>" . $unit[1] . " " . _('Unit') . "</i><br/>" ;
																				}
																			}
																			print "<span style='font-size: 85%; font-weight: normal; font-style: italic'>" ;
																				print $row["summary"] ;
																			print "</span>" ;
																		print "</td>" ;
																		print "<td>" ;
																		...
																		print "</td>" ;
																		print "<td>" ;
																			print "<a href='" . $_SESSION[$guid]["absoluteURL"] . "/index.php?q=/modules/Planner/planner_view_full.php&search=" . $students[$i][4] . "&viewBy=date&gibbonPlannerEntryID=" . $row["gibbonPlannerEntryID"] . "&date=$date&width=1000&height=550'><img title='" . _('View Record') . "' src='./themes/" . $_SESSION[$guid]["gibbonThemeName"] . "/img/plus.png'/></a> " ;
																		print "</td>" ;
																	print "</tr>" ;
																}
															print "</table>" ;
													...
													try {
														$data=array("gibbonSchoolYearID"=>$_SESSION[$guid]["gibbonSchoolYearID"],"gibbonPersonID"=>$students[$i][4]); 
														$sql="
