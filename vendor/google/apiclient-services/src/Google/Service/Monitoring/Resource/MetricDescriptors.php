 ...
 *  </code>
 */
class Google_Service_Monitoring_Resource_MetricDescriptors extends Google_Service_Resource
{
  /**
   ...
   * Stackdriver account. (metricDescriptors.listMetricDescriptors)
   *
   * @param string $name The project on which to execute the request. The format
   * is "projects/{project_id_or_number}".
   * @param array $optParams Optional parameters.
   ...
   */
  public function listMetricDescriptors($name, $optParams = array())
  {
    $params = array('name' => $name);
    $params = array_merge($params, $optParams);
