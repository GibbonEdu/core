<?php  //[STAMP] a6d8d656ee902fc1fed5cce531fcac46
...
trait AcceptanceTesterActions
{
     ...
     * @return   [type]
     * @see \Helper\Acceptance::grabAllFormValues()
     */
    public function grabAllFormValues($selector = null) {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('grabAllFormValues', func_get_args()));
    }
     ...
     *
     * Conditional Assertion: Test won't be stopped on fail
     * @see \Helper\Acceptance::seeFieldIsNotEmpty()
     */
    public function canSeeFieldIsNotEmpty($selector) {
        return $this->getScenario()->runStep(new \Codeception\Step\ConditionalAssertion('seeFieldIsNotEmpty', func_get_args()));
    }
    /**
     * [!] Method is generated. Documentation taken from corresponding module.
     *
    ...
    public function seeFieldIsNotEmpty($selector) {
        return $this->getScenario()->runStep(new \Codeception\Step\Assertion('seeFieldIsNotEmpty', func_get_args()));
    }
     ...
     * @see \Codeception\Module\DbHelper::deleteFromDatabase()
     */
 ...
 * @param array $criteria conditions. See seeInDatabase() method.
 * @return boolean Returns TRUE on success or FALSE on failure.
     * @see \Codeception\Module\DbHelper::updateFromDatabase()
     */
    public function updateFromDatabase($table, $data, $criteria) {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('updateFromDatabase', func_get_args()));
    }
     ...
     * @return boolean Returns TRUE on success or FALSE on failure.
     * @see \Codeception\Module\DbHelper::executeOnDatabase()
     */
    public function executeOnDatabase($sql) {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('executeOnDatabase', func_get_args()));
    }
