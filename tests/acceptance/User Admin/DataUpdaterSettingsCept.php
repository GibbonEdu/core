...
$I->selectOption('settings[Staff][citizenship1]', 'required');
$I->selectOption('settings[Staff][citizenship1Passport]', 'required');
$I->selectOption('settings[Staff][citizenship2]', 'required');
$I->selectOption('settings[Staff][citizenship2Passport]', 'required');
$I->selectOption('settings[Staff][religion]', 'required');
$I->selectOption('settings[Staff][nationalIDCardNumber]', 'required');
$I->selectOption('settings[Staff][residencyStatus]', 'required');
$I->selectOption('settings[Staff][visaExpiryDate]', 'required');
...
$I->seeInField('settings[Staff][citizenship1]', 'required');
$I->seeInField('settings[Staff][citizenship1Passport]', 'required');
$I->seeInField('settings[Staff][citizenship2]', 'required');
$I->seeInField('settings[Staff][citizenship2Passport]', 'required');
$I->seeInField('settings[Staff][religion]', 'required');
$I->seeInField('settings[Staff][nationalIDCardNumber]', 'required');
$I->seeInField('settings[Staff][residencyStatus]', 'required');
$I->seeInField('settings[Staff][visaExpiryDate]', 'required');
