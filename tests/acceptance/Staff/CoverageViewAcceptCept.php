<?php
/**
 * @covers modules/Staff/coverage_view_accept.php
 */
$I = new AcceptanceTester($scenario);
$I->wantTo('check Accept Coverage Request');
$I->loginAsAdmin();
...
$I->amOnModulePage('Staff', 'coverage_view_accept.php', [
    'gibbonStaffCoverageID' => $gibbonStaffCoverageID,
]);
$I->seeBreadcrumb('Accept Coverage Request');
