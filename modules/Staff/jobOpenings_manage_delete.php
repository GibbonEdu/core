...
if (isActionAccessible($guid, $connection2, "/modules/Staff/jobOpenings_manage_delete.php")==FALSE) {
	...
	if ($gibbonStaffJobOpeningID=="") {
		...
		if ($result->rowCount()!=1) {
			...
			$row=$result->fetch() ;
			?>
			<form method="post" action="<?php print $_SESSION[$guid]["absoluteURL"] . "/modules/" . $_SESSION[$guid]["module"] . "/jobOpenings_manage_deleteProcess.php?gibbonStaffJobOpeningID=$gibbonStaffJobOpeningID" ?>">
