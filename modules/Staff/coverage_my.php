...
if (isActionAccessible($guid, $connection2, Resource::fromRoute('Staff', 'coverage_my')) == false) {
    // Access denied
    ...
    if (isActionAccessible($guid, $connection2, Resource::fromRoute('Staff', 'coverage_request')) || $coverage->getResultCount() > 0) {
