			...
			<form method="post" action="<?php print $_SESSION[$guid]["absoluteURL"] . "/modules/" . $_SESSION[$guid]["module"] . "/applicationForm_manage_editProcess.php?search=$search" ?>" enctype="multipart/form-data">
				<table class='smallIntBorder' cellspacing='0' style="width: 100%">
					...
					<tr>
						...
						<td class="right">
							<input readonly name="gibbonStaffApplicationFormID" id="gibbonStaffApplicationFormID" value="<?php print htmlPrep($row["gibbonStaffApplicationFormID"]) ?>" type="text" style="width: 300px">
						</td>
					</tr>
					<tr>
						<td>
					...
					<tr>
						<td>
							...
							<span style="font-size: 90%"><i><?php print __($guid, 'Intended first day at school.') ?><br/>Format <?php if ($_SESSION[$guid]["i18n"]["dateFormat"]=="") { print "dd/mm/yyyy" ; } else { print $_SESSION[$guid]["i18n"]["dateFormat"] ; } ?></i></span>
						</td>
						<td class="right">
					...
					<tr>
						...
						<td class="right">
							<input readonly name="type" id="type" maxlength=30 value="<?php print htmlPrep($row["type"]) ?>" type="text" style="width: 300px">
						</td>
					</tr>
					<tr>
						<td style='width: 275px'> 
						...
						<td class="right">
							<input readonly name="jobTitle" id="jobTitle" maxlength=30 value="<?php print htmlPrep($row["jobTitle"]) ?>" type="text" style="width: 300px">
							<input name="gibbonStaffJobOpeningID" id="gibbonStaffJobOpeningID" value="<?php print htmlPrep($row["gibbonStaffJobOpeningID"]) ?>" type="hidden" style="width: 300px">
						</td>
					</tr>
					<?php
					...
					if ($row["gibbonPersonID"]!=NULL) {
						...
						<tr>
							...
							<td class="right">
								<input readonly name="surname" id="surname" maxlength=30 value="<?php print htmlPrep($row["surname"]) ?>" type="text" style="width: 300px">
							</td>
						</tr>
						<tr>
							<td> 
							...
							<td class="right">
								<input readonly name="preferredName" id="preferredName" maxlength=30 value="<?php print htmlPrep($row["preferredName"]) ?>" type="text" style="width: 300px">
							</td>
						</tr>
						<?php
					}
						...
						<tr>
							...
							<td class="right">
								<input title='Please enter full name as shown in ID documents' name="officialName" id="officialName" maxlength=150 value="<?php print htmlPrep($row["officialName"]) ?>" type="text" style="width: 300px">
								<script type="text/javascript">
						...
						<tr>
							...
							<td class="right">
								<input name="dob" id="dob" maxlength=10 value="<?php if ($row["dob"]!="") { print dateConvertBack($guid, $row["dob"]) ; } ?>" type="text" style="width: 300px">
								<script type="text/javascript">
						...
						<tr>
							...
							<td class="right">
								<input name="visaExpiryDate" id="visaExpiryDate" maxlength=10 value="<?php if ($row["visaExpiryDate"]!="") { print dateConvertBack($guid, $row["visaExpiryDate"]) ; } ?>" type="text" style="width: 300px">
								<script type="text/javascript">
						...
						<tr>
							...
							<td class="right">
								<input name="homeAddress" id="homeAddress" maxlength=255 value="<?php print htmlPrep($row["homeAddress"]) ?>" type="text" style="width: 300px">
								<script type="text/javascript">
						...
						<tr>
							...
							<td class="right">
								<input name="homeAddressDistrict" id="homeAddressDistrict" maxlength=30 value="<?php print htmlPrep($row["homeAddressDistrict"]) ?>" type="text" style="width: 300px">
							</td>
							<script type="text/javascript">
								$(function() {
									var availableTags=[
