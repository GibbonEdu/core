...
if (isActionAccessible($guid, $connection2, '/modules/Staff/staff_manage_delete.php') == false) {
    ...
    if ($gibbonStaffID == '') {
        ...
        if ($result->rowCount() != 1) {
            ...
            ?>
			<form method="post" action="<?php echo $_SESSION[$guid]['absoluteURL'].'/modules/'.$_SESSION[$guid]['module']."/staff_manage_deleteProcess.php?gibbonStaffID=$gibbonStaffID&search=$search&allStaff=$allStaff" ?>">
