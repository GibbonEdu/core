...
if (isActionAccessible($guid, $connection2, "/modules/Staff/applicationForm_manage_delete.php")==FALSE) {
	...
	if ($gibbonStaffApplicationFormID=="") {
		...
		if ($result->rowCount()!=1) {
			...
			print "</div>" ;
			?>
			<form method="post" action="<?php print $_SESSION[$guid]["absoluteURL"] . "/modules/" . $_SESSION[$guid]["module"] . "/applicationForm_manage_deleteProcess.php?gibbonStaffApplicationFormID=$gibbonStaffApplicationFormID&search=$search" ?>">
