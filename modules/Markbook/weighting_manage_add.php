    ...
    if ($highestAction == false) {
        ...
        //Check existence of and access to this class.
            ...
            if ($result->rowCount() != 1) {
                ...
                ?>
                <form method="post" action="<?php echo $_SESSION[$guid]['absoluteURL'].'/modules/'.$_SESSION[$guid]['module']."/weighting_manage_addProcess.php?gibbonCourseClassID=$gibbonCourseClassID" ?>">
                    <table class='smallIntBorder fullWidth' cellspacing='0'>    
                        <tr class='break'>
                            <td colspan=2> 
                                <h3>
                                    <?php echo __($guid, 'Add Markbook Weighting') ?>
                                </h3>
                            </td>
                        </tr>
                        <?php
                        ...
                        <tr>
                            ...
                            <td> 
                                <input name="description" id="description" maxlength=50 value="" type="text" class='standardWidth'>
                                <script type="text/javascript">
                        ...
                        <tr>
                            ...
                            <td> 
                                <input name="weighting" id="weighting" maxlength=6 value="0" type="text" class='standardWidth'>
                                <script type="text/javascript">
