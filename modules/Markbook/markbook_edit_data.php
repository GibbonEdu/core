                ...
                if ($result2->rowCount() != 1) {
                    ...
                    if ($resultStudents->rowCount() < 1) {
                        ...
                        while ($rowStudents = $resultStudents->fetch()) {
                            ...
                            echo "<b><a title='".$rowStudents['officialName']."' href='index.php?q=/modules/Students/student_view_details.php&gibbonPersonID=".$rowStudents['gibbonPersonID'].'&subpage=Markbook#'.$gibbonCourseClassID."'>";
