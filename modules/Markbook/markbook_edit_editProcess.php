        ...
        if (empty($_POST)) {
            ...
            if ($gibbonMarkbookColumnID == '' or $gibbonCourseClassID == '') {
                ...
                if ($result->rowCount() != 1) {
                    ...
                    $attainmentType = $_POST['attainmentType'] ?? $row['attainmentType'];
