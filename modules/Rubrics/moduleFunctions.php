				...
				$output.="<tr class='head'>" ;
					...
					for ($n=0; $n<$columnCount; $n++) {
						$output.="<td style='vertical-align: bottom'>" ;
							...
							$output.="<a onclick='return confirm(\"Are you sure you want to delete this column? Any unsaved changes will be lost.\")' href='" . $_SESSION[$guid]["absoluteURL"] . "/modules/" . $_SESSION[$guid]["module"] . "/rubrics_edit_deleteColumnProcess.php?gibbonRubricID=$gibbonRubricID&gibbonRubricColumnID=" . $columns[$n][0] . "&address=" . $_GET["q"] . "'><img title='Delete' src='./themes/" . $_SESSION[$guid]["gibbonThemeName"] . "/img/garbage.png'/ style='margin: 2px 0px 0px 0px'></a>" ;	
						$output.="</td>" ;
					}
				$output.="</tr>" ;
