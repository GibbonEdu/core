...
if (isActionAccessible($guid, $connection2, '/modules/Interventions/interventions_manage_contributor_delete.php') == false) {
    ...
    if (empty($highestAction)) {
        ...
        $gibbonINInterventionContributorID = $_GET['gibbonINInterventionContributorID'] ?? '';
        ...
        $form = DeleteForm::createForm($session->get('absoluteURL').'/modules/Interventions/interventions_manage_contributor_deleteProcess.php', true);
        $form->addHiddenValue('address', $session->get('address'));
        $form->addHiddenValue('gibbonINInterventionID', $gibbonINInterventionID);
        $form->addHiddenValue('gibbonINInterventionContributorID', $gibbonINInterventionContributorID);
