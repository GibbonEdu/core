...
$URL = $_SESSION[$guid]['absoluteURL'].'/index.php?q=/modules/Interventions/intervention_support_plan_note_add.php&gibbonINInterventionID='.$gibbonINInterventionID.'&gibbonINSupportPlanID='.$gibbonINSupportPlanID;
...
if (isActionAccessible($guid, $connection2, '/modules/Interventions/intervention_support_plan_note_add.php') == false) {
    ...
    try {
        ...
        // Insert the note
        $gibbonINSupportPlanNoteID = $supportPlanNoteGateway->insert($data);
