...
$URL = getInterventionRedirectURL($session, $gibbonINInterventionID, $gibbonINInterventionEligibilityAssessmentID, $gibbonPersonIDStudent, $gibbonFormGroupID, $gibbonYearGroupID, $status, $returnProcess, $isContributor);
