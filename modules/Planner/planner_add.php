		...
		if ($proceed==FALSE) {
			...
			if (!($addReturn=="")) {
				if ($addReturn=="fail0") {
					...
					$addReturnMessage ="Add failed because your attachments were way too big." ;	
				}
				...
				<table style="width: 100%">	
					...
					<tr>
						...
						<td class="right">
							...
							if ($viewBy=="date") {
								?>
								<input readonly name="date" id="date" maxlength=10 value="<? print dateConvertBack($date) ?>" type="text" style="width: 300px">
								<?
							}
							else {
								?>
