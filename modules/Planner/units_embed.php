			...
			if ($gibbonUnitID=="") {
				...
				if ($result->rowCount()!=1) {
					...
					if ($_SESSION[$guid]["webLink"]=="") {
						print "<p>This unit was built with, and is powered by, <a target='_parent' href='http://www.thegibbon.org'>Gibbon</a> (the open, flexible and free school platform) at " . $_SESSION[$guid]["organisationName"] . "</p>" ;
					}
					else {
						print "<p>This unit was built with, and is powered by, <a target='_parent' href='http://www.thegibbon.org'>Gibbon</a> (the open, flexible and free school platform) at <a target='_parent' href='" . $_SESSION[$guid]["webLink"] . "'>" . $_SESSION[$guid]["organisationName"] . "</a></p>" ;
					}
				}
			}
		}
