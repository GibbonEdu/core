        ...
        if ($gibbonPlannerEntryID == '' or ($viewBy == 'class' and $gibbonCourseClassID == 'Y')) {
            ...
            if ($result->rowCount() != 1) {
                ...
                if ($setting['value'] == 'Y') {
                    ...
                    $row->addCheckbox('includeVideoChat')->setValue('Y')->description(__('Include video chat'));
                    $row->addCheckbox('sendVideoLink')->setValue('Y')->description(__('Send 10 minute class start warning with video link'));
                }  
