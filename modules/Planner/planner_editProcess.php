        ...
        if (empty($_POST)) {
            ...
            if ($gibbonPlannerEntryID == '' or ($viewBy == 'class' and $gibbonCourseClassID == '')) {
                ...
                if ($result->rowCount() != 1) {
                    ...
                    //Video Chat settings
                    $includeVideoChat = $_POST['includeVideoChat'] ? 'Y' : 'N';
                    $sendVideoLink = $_POST['sendVideoLink'] ? 'Y' : 'N';
