...
if (isActionAccessible($guid, $connection2, '/modules/Formal Assessment/assessment_view.php') == false) {
    //Access denied
    ...
    if ($highestAction == false) {
        ...
        if ($type == 'internal') {
            if ($highestAction == 'View Internal Assessments_all') { //ALL STUDENTS
                ...
                $form->addHiddenValue('q', '/modules/Formal Assessment/assessment_view.php');
                $form->addHiddenValue('address', $session->get('address'));
                $form->addHiddenValue('type', 'internal');
            ...
            if ($highestAction == 'View External Assessments_myChildrens') { //MY CHILDREN
                ...
                if ($result->rowCount() < 1) {
                    ...
                    if (count($options) == 0) {
                        ...
                        $form->addHiddenValue('q', '/modules/Formal Assessment/assessment_view.php');
                        $form->addHiddenValue('address', $session->get('address'));
                        $form->addHiddenValue('type', 'external');
                    ...
                    if ($gibbonPersonID != '' and count($options) > 0) {
                        ...
                        if ($resultChild->rowCount() < 1) {
                            ...
                            $rowChild = $resultChild->fetch();
                            echo externalAssessmentDetails($guid, $gibbonPersonID, $connection2, null, false);
                        }
                    }
                }
