...
if (isActionAccessible($guid, $connection2, "/modules/School Admin/inDescriptors_manage_delete.php")==FALSE) {
	...
	if ($gibbonINDescriptorID=="") {
		...
		if ($result->rowCount()!=1) {
			...
			$row=$result->fetch() ;
			?>
			<form method="post" action="<? print $_SESSION[$guid]["absoluteURL"] . "/modules/" . $_SESSION[$guid]["module"] . "/inDescriptors_manage_deleteProcess.php?gibbonINDescriptorID=$gibbonINDescriptorID" ?>">
