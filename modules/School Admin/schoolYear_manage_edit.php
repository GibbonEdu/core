			...
			<form method="post" action="<?php print $_SESSION[$guid]["absoluteURL"] . "/modules/" . $_SESSION[$guid]["module"] . "/schoolYear_manage_editProcess.php?gibbonSchoolYearID=$gibbonSchoolYearID" ?>">
				<table class='smallIntBorder fullWidth' cellspacing='0'>	
					...
					<tr>
						...
						<td class="right">
							<input name="firstDay" id="firstDay" maxlength=10 value="<?php if (isset($row["firstDay"])) { print dateConvertBack($guid, $row["firstDay"]) ; } ?>" type="text" class="standardWidth">
							<script type="text/javascript">
					...
					<tr>
						...
						<td class="right">
							<input name="lastDay" id="lastDay" maxlength=10 value="<?php if (isset($row["lastDay"])) { print dateConvertBack($guid, $row["lastDay"]) ; } ?>" type="text" class="standardWidth">
							<script type="text/javascript">
