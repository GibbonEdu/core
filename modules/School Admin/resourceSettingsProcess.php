...
$URL = $session->get('absoluteURL').'/index.php?q=/modules/'.getModuleName($_POST['address']).'/resourceSettings.php';

if (isActionAccessible($guid, $connection2, Resource::fromRoute('School Admin', 'resourceSettings')) == false) {
    $URL .= '&return=error0';
    header("Location: {$URL}");
} else {
    //Proceed!
