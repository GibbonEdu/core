...
if (isActionAccessible($guid, $connection2, "/modules/School Admin/house_manage_delete.php")==FALSE) {
	...
	if ($gibbonHouseID=="") {
		...
		if ($result->rowCount()!=1) {
			...
			$row=$result->fetch() ;
			?>
			<form method="post" action="<? print $_SESSION[$guid]["absoluteURL"] . "/modules/" . $_SESSION[$guid]["module"] . "/house_manage_deleteProcess.php?gibbonHouseID=$gibbonHouseID" ?>">
				<table class='smallIntBorder' cellspacing='0' style="width: 100%">	
					<tr>
						<td> 
							<b>Are you sure you want to delete house "<? print $row["name"] ?>"?</b><br/>
