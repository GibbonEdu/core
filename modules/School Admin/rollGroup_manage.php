...
if (isActionAccessible($guid, $connection2, "/modules/School Admin/rollGroup_manage.php")==FALSE) {
	...
	if ($gibbonSchoolYearID!="") {
		...
		print "<div class='linkTop'>" ;
		print "<a href='" . $_SESSION[$guid]["absoluteURL"] . "/index.php?q=/modules/" . $_SESSION[$guid]["module"] . "/rollGroup_manage_add.php&gibbonSchoolYearID=$gibbonSchoolYearID'><img title='" . _('Add New Record') . "' src='./themes/" . $_SESSION[$guid]["gibbonThemeName"] . "/img/page_new.png'/></a>" ;
		print "</div>" ;
