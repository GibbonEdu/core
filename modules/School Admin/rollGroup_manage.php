    ...
    if ($gibbonSchoolYearID != '') {
        ...
        if ($result->rowCount() < 1) {
            ...
            while ($row = $result->fetch()) {
                ...
                echo "<a href='".$_SESSION[$guid]['absoluteURL'].'/index.php?q=/modules/'.$_SESSION[$guid]['module'].'/rollGroup_manage_delete.php&gibbonRollGroupID='.$row['gibbonRollGroupID']."&gibbonSchoolYearID=$gibbonSchoolYearID'><img title='".__($guid, 'Delete')."' src='./themes/".$_SESSION[$guid]['gibbonThemeName']."/img/garbage.png'/></a> ";
                echo '</td>';
                echo '</tr>';
