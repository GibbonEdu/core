...
$URL = $session->get('absoluteURL').'/index.php?q=/modules/'.getModuleName($_POST['address'])."/space_manage_edit.php&gibbonSpaceID=$gibbonSpaceID";

if (isActionAccessible($guid, $connection2, Resource::fromRoute('School Admin', 'space_manage_edit')) == false) {
    $URL .= '&return=error0';
    header("Location: {$URL}");
} else {
    //Proceed!
