...
if (isActionAccessible($guid, $connection2, "/modules/School Admin/fileExtensions_manage_delete.php")==FALSE) {
	...
	if ($gibbonFileExtensionID=="") {
		...
		if ($result->rowCount()!=1) {
			print "<div class='error'>" ;
				print "The specified file extension cannot be found." ;
			print "</div>" ;
		}
		else {
			//Let's go!
			$row=$result->fetch() ;
			?>
			<form method="post" action="<? print $_SESSION[$guid]["absoluteURL"] . "/modules/" . $_SESSION[$guid]["module"] . "/fileExtensions_manage_deleteProcess.php?gibbonFileExtensionID=$gibbonFileExtensionID" ?>">
				<table style="width: 100%">	
					<tr>
						<td> 
							<b>Are you sure you want to delete file extension "<? print $row["name"] ?>"?</b><br/>
