...
if (isActionAccessible($guid, $connection2, "/modules/School Admin/externalAssessments_manage_edit_field_delete.php")==FALSE) {
	...
	if ($gibbonExternalAssessmentFieldID=="" OR $gibbonExternalAssessmentID=="") {
		...
		if ($result->rowCount()!=1) {
			print "<div class='error'>" ;
				print "The specified grade cannot be found." ;
			print "</div>" ;
		}
		else {
			//Let's go!
			...
			?>
			<form method="post" action="<? print $_SESSION[$guid]["absoluteURL"] . "/modules/" . $_SESSION[$guid]["module"] . "/externalAssessments_manage_edit_field_deleteProcess.php?gibbonExternalAssessmentFieldID=$gibbonExternalAssessmentFieldID&gibbonExternalAssessmentID=$gibbonExternalAssessmentID" ?>">
				<table class='smallIntBorder' cellspacing='0' style="width: 100%">	
					<tr>
						<td> 
							<b>Are you sure you want to delete field "<? print $row["name"] ?>"?</b><br/>
