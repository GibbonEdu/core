...
$URL = $session->get('absoluteURL').'/index.php?q=/modules/'.getModuleName($_POST['address']).'/yearGroup_manage_add.php';

if (isActionAccessible($guid, $connection2, new Action('School Admin', 'yearGroup_manage_add')) == false) {
    $URL .= '&return=error0';
    header("Location: {$URL}");
} else {
    //Proceed!
