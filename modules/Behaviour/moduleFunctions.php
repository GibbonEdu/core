    ...
    if (empty($schoolYears)) {
        ...
        foreach ($schoolYears as $schoolYear) {
            ...
            if ($schoolYear['gibbonSchoolYearID'] == $session->get('gibbonSchoolYearID')) {
                if (isActionAccessible($guid, $connection2, Resource::fromRoute('Behaviour', 'behaviour_manage'))) {
            ...
            if (isActionAccessible($guid, $connection2, Resource::fromRoute('Behaviour', 'behaviour_manage')) && $schoolYear['gibbonSchoolYearID'] == $session->get('gibbonSchoolYearID')) {
