...
if (isActionAccessible($guid, $connection2, '/modules/System Admin/thirdPartySettings.php') == false) {
    ...
    // PAYPAL
    $form->addRow()->addHeading('PayPal Payment Gateway');
    ...
    // SMTP MAIL
    $form->addRow()->addHeading('SMTP Mail');
