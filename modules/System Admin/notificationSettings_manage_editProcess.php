...
$URL = $session->get('absoluteURL').'/index.php?q=/modules/'.getModuleName($_POST['address'])."/notificationSettings.php";

if (isActionAccessible($guid, $connection2, Resource::fromRoute('System Admin', 'notificationSettings_manage_edit')) == false) {
    $URL .= '&return=error0';
    header("Location: {$URL}");
    exit;
} else {
