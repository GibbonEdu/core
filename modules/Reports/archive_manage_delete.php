...
if (isActionAccessible($guid, $connection2, '/modules/Reports/archive_manage_delete.php') == false) {
    ...
    $values = $container->get(ReportArchiveGateway::class)->getByID($gibbonReportArchiveID);
    ...
    $form = DeleteForm::createForm($session->get('absoluteURL').'/modules/Reports/archive_manage_deleteProcess.php', true);
