...
if (isActionAccessible($guid, $connection2, '/modules/Reports/criteriaTypes_manage_delete.php') == false) {
    ...
    $values = $container->get(ReportingCriteriaTypeGateway::class)->getByID($gibbonReportingCriteriaTypeID);
    ...
    $form = DeleteForm::createForm($session->get('absoluteURL').'/modules/Reports/criteriaTypes_manage_deleteProcess.php', true);
