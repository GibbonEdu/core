...
if (isActionAccessible($guid, $connection2, '/modules/Reports/reporting_cycles_manage_delete.php') == false) {
    ...
    $values = $container->get(ReportingCycleGateway::class)->getByID($gibbonReportingCycleID);
    ...
    $form = DeleteForm::createForm($session->get('absoluteURL').'/modules/Reports/reporting_cycles_manage_deleteProcess.php', true);
