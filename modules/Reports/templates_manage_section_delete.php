...
if (isActionAccessible($guid, $connection2, '/modules/Reports/templates_manage_section_delete.php') == false) {
    ...
    $values = $container->get(ReportTemplateSectionGateway::class)->selectBy([
    ...
    $form = DeleteForm::createForm($session->get('absoluteURL').'/modules/Reports/templates_manage_section_deleteProcess.php', true);
