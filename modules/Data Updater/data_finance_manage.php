    ...
    if ($result->rowCount() < 1) {
        ...
        while ($row = $resultPage->fetch()) {
            ...
            if ($row['status'] == 'Pending') {
                echo "<a href='".$_SESSION[$guid]['absoluteURL'].'/index.php?q=/modules/'.$_SESSION[$guid]['module'].'/data_finance_manage_edit.php&gibbonFinanceInvoiceeUpdateID='.$row['gibbonFinanceInvoiceeUpdateID']."' title='".__($guid, 'Edit')."'><img src='./themes/".$_SESSION[$guid]['gibbonThemeName']."/img/config.png'/></a> ";
