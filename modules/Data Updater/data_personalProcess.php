            ...
            if ($checkCount < 1) {
                ...
                if ($result->rowCount() != 1) {
                    ...
                    $data = [
                        ...
                        'citizenship1PassportExpiry'   => $_POST['citizenship1PassportExpiry'] ?? $row['citizenship1PassportExpiry'],
                        'citizenship2'           => $_POST['citizenship2'] ?? $row['citizenship2'],
                        'citizenship2Passport'   => $_POST['citizenship2Passport'] ?? $row['citizenship2Passport'],
                        'citizenship2PassportExpiry'   => $_POST['citizenship2PassportExpiry'] ?? $row['citizenship2PassportExpiry'],
