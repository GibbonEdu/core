...
if (isActionAccessible($guid, $connection2, "/modules/Library/library_browse.php")==FALSE) {
	...
	print "<div class='trailHead'><a href='" . $_SESSION[$guid]["absoluteURL"] . "'>" . _("Home") . "</a> > <a href='" . $_SESSION[$guid]["absoluteURL"] . "/index.php?q=/modules/" . getModuleName($_GET["q"]) . "/" . getModuleEntry($_GET["q"], $connection2, $guid) . "'>" . getModuleName($_GET["q"]) . "</a> > </div><div class='trailEnd'>Browse The Library</div>" ;
	print "</div>" ;
			...
			print "<table class='noIntBorder' cellspacing='0' style='width: 100%; background-color: rgba(255,255,255,0.8); border: 1px solid #444; margin-top: 30px'>" ;
				print "<tr>" ;
					...
					print "<td style='width: 33%; padding-top: 5px; text-align: center; vertical-align: top'>" ;
						print "<div style='color: #CC0000; margin-bottom: -2px; font-weight: bold; font-size: 135%'>All Time Top 5</div>" ; 
						try {
							$dataTop=array(); 
						...
						if ($resultTop->rowCount()<1) {
							print "<div class='warning'>There is no data to display</div>" ; 
						}
						else {
							$count=0 ;
					...
					print "</td>" ;
					print "<td style='width: 33%; padding-top: 5px; text-align: center; vertical-align: top'>" ;
						print "<div style='color: #CC0000; margin-bottom: -2px; font-weight: bold; font-size: 135%'>Monthly Top 5</div>" ; 
						try {
					...
					print "</td>" ;
					print "<td style='width: 33%; padding-top: 5px; text-align: center; vertical-align: top'>" ;
						print "<div style='color: #CC0000; margin-bottom: -5px; font-weight: bold; font-size: 135%'>New Titles</div>" ;  
						try {
							$dataTop=array(); 
			...
			if ($result->rowCount()<1) {
				...
				print "<table class='smallIntBorder' cellspacing='0' style='width: 100%; border: 1px solid #444'>" ;
					print "<tr class='head' style='opacity: 0.7'>" ;
						...
						print "<th>" ;
							print "ID<br/>" ;
							print "<span style='font-size: 85%; font-style: italic'>Status</span>" ;
						print "</th>" ;
						print "<th>" ;
							print "Location" ;
						print "</th>" ;
					...
					while ($row=$resultPage->fetch()) {
						...
						print "<tr class=$rowNum style='opacity: 1.0'>" ;
							...
							print "<td>" ;
								...
								print "</script>" ;
								if ($row["fields"]!="") {
									print "<a title='View Description' class='show_hide-$count' onclick='false' href='#'><img style='padding-right: 5px' src='" . $_SESSION[$guid]["absoluteURL"] . "/themes/Default/img/page_down.png' alt='Show Details' onclick='return false;' /></a>" ;
								}
							print "</td>" ;
						print "</tr>" ;
						if ($row["fields"]!="") {
