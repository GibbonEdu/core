...
if (isActionAccessible($guid, $connection2, '/modules/Library/library_manage_catalog_duplicate.php') == false) {
                ...
                for ($i = 1; $i <= $number; ++$i) {
                    ...
                    ?>
									<script type="text/javascript">
										...
										id<?php echo $i ?>.add( Validate.Exclusion, { within: [<?php echo $idList;
    ...
    echo $_SESSION[$guid]['i18n']['dateFormat'];
                    ...
                    $selectContents .= '</optgroup>';
                    ?>
							<tr id="ownershipTypeSchoolRow<?php echo $i ?>" <?php if ($row['ownershipType'] != 'School') {
    echo "style='display: none'";
                    ...
                    ?>>
							...
							<tr id="ownershipTypeIndividualRow<?php echo $i ?>" <?php if ($row['ownershipType'] != 'Individual') {
    echo "style='display: none'";
}
                    ?>>
								<td> 
