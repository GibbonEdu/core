...
if (isActionAccessible($guid, $connection2, "/modules/External Assessment/externalAssessment_manage_details_delete.php")==FALSE) {
	...
	if ($gibbonExternalAssessmentStudentID=="" OR $gibbonPersonID=="") {
		print "<div class='error'>" ;
			print "You have not specified a student or assessment." ;
		print "</div>" ;
	}
	else {
		try {
		...
		if ($result->rowCount()!=1) {
			...
			?>
			<form method="post" action="<? print $_SESSION[$guid]["absoluteURL"] . "/modules/" . $_SESSION[$guid]["module"] . "/externalAssessment_manage_details_deleteProcess.php?gibbonExternalAssessmentStudentID=$gibbonExternalAssessmentStudentID&gibbonPersonID=$gibbonPersonID&search=$search" ?>">
				<table style="width: 100%">	
					<tr>
						<td> 
							<b>Are you sure you want to delete this assessment?</b><br/>
