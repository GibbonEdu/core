...
if (isActionAccessible($guid, $connection2, "/modules/Individual Needs/in_view.php")==FALSE) {
	...
	if ($highestAction==FALSE) {
		...
		print "<div class='trailHead'><a href='" . $_SESSION[$guid]["absoluteURL"] . "'>" . _("Home") . "</a> > <a href='" . $_SESSION[$guid]["absoluteURL"] . "/index.php?q=/modules/" . _(getModuleName($_GET["q"])) . "/" . getModuleEntry($_GET["q"], $connection2, $guid) . "'>" . getModuleName($_GET["q"]) . "</a> > </div><div class='trailEnd'>" . _('View Student Records') . "</div>" ;
		print "</div>" ;
			...
			<table class='noIntBorder' cellspacing='0' style="width: 100%">	
				...
				<tr>
					<td colspan=2 class="right">
						...
						<?php
						print "<a href='" . $_SESSION[$guid]["absoluteURL"] . "/index.php?q=/modules/" . $_SESSION[$guid]["module"] . "/in_view.php'>" . _('Clear Search') . "</a>" ;
						?>
