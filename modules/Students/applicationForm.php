		...
		<table class='smallIntBorder' cellspacing='0' style="width: 100%">	
			...
			<tr>
				<td> 
					...
					<span style="font-size: 90%"><i><?php print __($guid, 'What school year will the student join in?') ?></i></span>
				</td>
				<td class="right">
			...
			<tr>
				<td> 
					...
					<span style="font-size: 90%"><i><?php print __($guid, 'Student\'s intended first day at school.') ?><br/><?php print __($guid, 'Format:') ?> <?php if ($_SESSION[$guid]["i18n"]["dateFormat"]=="") { print "dd/mm/yyyy" ; } else { print $_SESSION[$guid]["i18n"]["dateFormat"] ; }?></i></span>
				</td>
				<td class="right">
			...
			if ($applicationFormRefereeLink!="") {
				...
				<tr>
					...
					<td class="right">
						<input name="referenceEmail" id="referenceEmail" maxlength=100 value="" type="text" style="width: 300px">
						<script type="text/javascript">
			...
			<tr>
				<td colspan=2 style='padding-top: 15px'> 
					...
					<span style="font-size: 90%"><i><?php print __($guid, 'Please give information on the last two schools attended by the applicant.') ?></i></span>
				</td>
			</tr>
			<tr>
				<td colspan=2> 
				...
				if (isset($_SESSION[$guid]["username"])) {
					...
					<tr>
						<td> 
							...
							<span style="font-size: 90%"><i><?php print __($guid, 'System login ID.') ?></i></span>
						</td>
						<td class="right">
				...
				for ($i=$start;$i<3;$i++) {
					...
					<tr <?php if ($i==2) { print "class='secondParent'" ; }?>>
						<td> 
							...
							print "<span style='font-size: 90%'><i>" . __($guid, 'Format:') . " " ; if ($_SESSION[$guid]["i18n"]["dateFormat"]=="") { print "dd/mm/yyyy" ; } else { print $_SESSION[$guid]["i18n"]["dateFormat"] ; } print ". " . __($guid, 'If relevant.') . "</i></span>" ;
							?>
						</td>
						<td class="right">
			...
			<tr>
				<td> 
					...
					<span style="font-size: 90%"><i><?php print __($guid, 'Is a scholarship required for you to take up a place at the school?') ?></i></span><br/>
				</td>
				<td class="right">
			...
			<tr id="companyEmailRow">
				...
				<td class="right">
					<input name="companyEmail" id="companyEmail" value="" type="text" style="width: 300px">
					<script type="text/javascript">
			...
			<tr id="tellUsMoreRow" style='display: none'>
				<td> 
					...
					<span style="font-size: 90%"><i><?php print __($guid, 'The name of a person or link to a website, etc.') ?></i></span>
				</td>
				<td class="right">
