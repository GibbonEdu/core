            ...
            if ($result->rowCount() != 1) {
                ...
                if ($gibbonStudentNoteID == '') {
                    ...
                    if ($result->rowCount() != 1) {
                        ...
                        ?>
						<form method="post" action="<?php echo $_SESSION[$guid]['absoluteURL'].'/modules/'.$_SESSION[$guid]['module']."/student_view_details_notes_deleteProcess.php?gibbonPersonID=$gibbonPersonID&search=".$_GET['search']."&subpage=$subpage&gibbonStudentNoteID=$gibbonStudentNoteID&category=".$_GET['category']."&allStudents=$allStudents" ?>">
