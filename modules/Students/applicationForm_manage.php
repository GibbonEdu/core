    ...
    if ($gibbonSchoolYearID != '') {
        ...
        $table->addColumn('student', __('Student'))
            ...
            ->format(function ($application) use ($applicationGateway, $session) {
                ...
                //GS//$output .= '<strong>'.Format::name('', $application['preferredName'], $application['surname'], 'Student', true, true) . '</strong><br/>';
                $output .= '<strong>'.Format::name('', $application['preferredName'], $application['surname'], 'Student', false, true) . '</strong><br/>'; //GS//
        ...
        //GS//$table->addColumn('schoolName1', __('Last School'))
        $table->addColumn('formGroupName', __('Roll Group')) //GS//
            ->format(function($application) {
                //GS//$school = $application['schoolName1'];
                return $application['formGroupName'];
                //GS//if ($application['schoolDate2'] > $application['schoolDate1'] && !empty($application['schoolName2'])) {
                //GS//    $school = $application['schoolName2'];
                //GS//}
                //GS//return Format::truncate($school, 20);
            });
