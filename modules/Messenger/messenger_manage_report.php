				...
				echo "<div id='tabs2'>";
					if (!is_null($gibbonMessengerID)) {
							...
							$sql = "SELECT surname, preferredName, gibbonPerson.gibbonPersonID, gibbonMessenger.*, gibbonMessengerReceipt.*, gibbonRole.category as roleCategory
								...
								WHERE gibbonMessengerReceipt.gibbonMessengerID=:gibbonMessengerID ORDER BY FIELD(confirmed, 'Y','N',NULL), confirmedTimestamp, preferredName, surname, contactType";
							$result = $connection2->prepare($sql);
							$result->execute($data);
