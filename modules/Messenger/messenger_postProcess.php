                                ...
                                if ($category == 'Parent') {
                                    ...
                                    while ($rowEmail = $resultEmail->fetch()) {
                                        if ($rowEmail['countryCode'] == '') {
                                            $phones .= $countryCode.$rowEmail['phone'].',';
                                            $phonesReport .= formatName('', $rowEmail['preferredName'], $rowEmail['surname'], 'Student', false).' ('.$countryCode.$rowEmail['phone'].'),';
                                        } else {
                                            $phones .= $rowEmail['countryCode'].$rowEmail['phone'].',';
                                            $phonesReport .= formatName('', $rowEmail['preferredName'], $rowEmail['surname'], 'Student', false).' ('.$rowEmail['countryCode'].$rowEmail['phone'].'),';
                                        }
                                    }
                                } else {
                                    try {
