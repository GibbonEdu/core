...
if (isActionAccessible($guid, $connection2, '/modules/Messenger/mailingLists_manage_delete.php') == false) {
    // Access denied
    ...
    $form = DeleteForm::createForm($session->get('absoluteURL').'/modules/Messenger/mailingLists_manage_deleteProcess.php');
    echo $form->getOutput();
}
