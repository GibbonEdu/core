...
$URL = $session->get('absoluteURL').'/index.php?q=/modules/'.getModuleName($session)."/department_course_edit.php&gibbonDepartmentID=$gibbonDepartmentID&gibbonCourseID=$gibbonCourseID";
