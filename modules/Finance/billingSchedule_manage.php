			...
			<table class='noIntBorder' cellspacing='0' style="width: 100%">	
				...
				<tr>
					<td> 
						...
						<span class="emphasis small"><?php echo __($guid, 'Billing schedule name.') ?></span>
					</td>
					<td class="right">
        ...
        ?>" type="text" class="standardWidth">
				...
				<tr>
					<td colspan=2 class="right">
						<input type="hidden" name="q" value="/modules/<?php echo $_SESSION[$guid]['module'] ?>/billingSchedule_manage.php">
