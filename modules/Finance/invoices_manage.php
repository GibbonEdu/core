						...
						while ($row=$result->fetch()) {
							...
							print "<tr class=$rowNum>" ;
								...
								print "<td>" ;
									...
									print "</script>" ;
									if ($row["notes"]!="") {
										print "<a title='View Notes' class='show_hide-$count' onclick='false' href='#'><img style='margin-left: 5px' src='" . $_SESSION[$guid]["absoluteURL"] . "/themes/" . $_SESSION[$guid]["gibbonThemeName"] . "/img/page_down.png' alt='" . __($guid, 'Show Comment') . "' onclick='return false;' /></a>" ;
									}
								print "</td>" ;
								print "<td>" ;
