...
if (isActionAccessible($guid, $connection2, '/modules/Finance/budgets_manage.php') == false) {
    ...
    if ($result->rowCount() < 1) {
        ...
        while ($row = $resultPage->fetch()) {
            ...
            echo "<a href='".$_SESSION[$guid]['absoluteURL'].'/index.php?q=/modules/'.$_SESSION[$guid]['module'].'/budgets_manage_delete.php&gibbonFinanceBudgetID='.$row['gibbonFinanceBudgetID']."'><img title='".__($guid, 'Delete')."' src='./themes/".$_SESSION[$guid]['gibbonThemeName']."/img/garbage.png'/></a> ";
            echo '</td>';
            echo '</tr>';
