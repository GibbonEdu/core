				...
				<table class='smallIntBorder' cellspacing='0' style="width: 100%">	
					...
					<tr>
						<td> 
							...
							<span style="font-size: 90%"><i><?php print __($guid, 'Intended issue date.') ."<br/>" . __($guid, 'Format:') ?> <?php if ($_SESSION[$guid]["i18n"]["dateFormat"]=="") { print "dd/mm/yyyy" ; } else { print $_SESSION[$guid]["i18n"]["dateFormat"] ; }?><br/></i></span>
						</td>
						<td class="right">
					...
					<tr>
						<td> 
							...
							<span style="font-size: 90%"><i><?php print __($guid, 'Final Payment Date.') . "<br/>" . __($guid, 'Format:') ?> <?php if ($_SESSION[$guid]["i18n"]["dateFormat"]=="") { print "dd/mm/yyyy" ; } else { print $_SESSION[$guid]["i18n"]["dateFormat"] ; }?><br/></i></span>
						</td>
						<td class="right">
