...
if (isActionAccessible($guid, $connection2, '/modules/Finance/budgets_manage_delete.php') == false) {
    ...
    if ($gibbonFinanceBudgetID == '') {
        ...
        if ($result->rowCount() != 1) {
            ...
            $row = $result->fetch()
            ?>
			<form method="post" action="<?php echo $_SESSION[$guid]['absoluteURL'].'/modules/'.$_SESSION[$guid]['module']."/budgets_manage_deleteProcess.php?gibbonFinanceBudgetID=$gibbonFinanceBudgetID" ?>">
