...
if (isActionAccessible($guid, $connection2, "/modules/Timetable Admin/tt.php")==FALSE) {
	...
	if ($gibbonSchoolYearID!="") {
		...
		print "<div class='linkTop'>" ;
		print "<a href='" . $_SESSION[$guid]["absoluteURL"] . "/index.php?q=/modules/" . $_SESSION[$guid]["module"] . "/tt_add.php&gibbonSchoolYearID=$gibbonSchoolYearID'><img title='" . _('Add New Record') . "' src='./themes/" . $_SESSION[$guid]["gibbonThemeName"] . "/img/page_new.png'/></a>" ;
		print "</div>" ;
