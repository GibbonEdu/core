...
if (isActionAccessible($guid, $connection2, "/modules/Timetable Admin/ttDates_edit.php")==FALSE) {
	...
	print "<div class='trailHead'><a href='" . $_SESSION[$guid]["absoluteURL"] . "'>" . _("Home") . "</a> > <a href='" . $_SESSION[$guid]["absoluteURL"] . "/index.php?q=/modules/" . _(getModuleName($_GET["q"])) . "/" . getModuleEntry($_GET["q"], $connection2, $guid) . "'>" . getModuleName($_GET["q"]) . "</a> > <a href='" . $_SESSION[$guid]["absoluteURL"] . "/index.php?q=/modules/" . getModuleName($_GET["q"]) . "/ttDates.php&gibbonSchoolYearID=" . $_GET["gibbonSchoolYearID"] . "'>" . _('Tie Days to Dates') . "</a> > </div><div class='trailEnd'>" . _('Edit Days in Date') . "</div>" ;
	print "</div>" ;
	...
	if ($gibbonSchoolYearID=="" OR $dateStamp=="") {
		...
		print "<a href='" . $_SESSION[$guid]["absoluteURL"] . "/index.php?q=/modules/" . $_SESSION[$guid]["module"] . "/ttDates_edit_add.php&gibbonSchoolYearID=" . $_GET["gibbonSchoolYearID"] . "&dateStamp=$dateStamp'><img title='" . _('Add New Record') . "' src='./themes/" . $_SESSION[$guid]["gibbonThemeName"] . "/img/page_new.png'/></a>" ;
		print "</div>" ;
