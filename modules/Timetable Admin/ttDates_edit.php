...
if (isActionAccessible($guid, $connection2, "/modules/Timetable Admin/ttDates_edit.php")==FALSE) {
	...
	if ($gibbonSchoolYearID=="" OR $dateStamp=="") {
		print "<div class='error'>" ;
			print "You have not specified a school year or date." ;
		print "</div>" ;
	}
	else {	
		try {
		...
		print "<a href='" . $_SESSION[$guid]["absoluteURL"] . "/index.php?q=/modules/" . $_SESSION[$guid]["module"] . "/ttDates_edit_add.php&gibbonSchoolYearID=" . $_GET["gibbonSchoolYearID"] . "&dateStamp=$dateStamp'><img title='New' src='./themes/" . $_SESSION[$guid]["gibbonThemeName"] . "/img/page_new.gif'/></a>" ;
		print "</div>" ;
			...
			print "<table cellspacing='0' style='width: 100%'>" ;
				...
				while ($row=$result->fetch()) {
					...
					print "<tr class=$rowNum>" ;
						...
						print "</td>" ;
						print "<td>" ;
							print "<a href='" . $_SESSION[$guid]["absoluteURL"] . "/index.php?q=/modules/" . $_SESSION[$guid]["module"] . "/ttDates_edit_delete.php&gibbonSchoolYearID=" . $_GET["gibbonSchoolYearID"] . "&dateStamp=$dateStamp&gibbonTTDayID=" . $row["gibbonTTDayID"] . "'><img title='Delete' src='./themes/" . $_SESSION[$guid]["gibbonThemeName"] . "/img/garbage.png'/></a> " ;
						print "</td>" ;
					print "</tr>" ;
