    ...
    if ($gibbonSchoolYearID == '' or $dateStamp == '') {
        ...
        if ($result->rowCount() < 1) {
            ...
            while ($row = $result->fetch()) {
                ...
                echo '</td>';
                echo '<td>';
                echo "<a href='".$_SESSION[$guid]['absoluteURL'].'/index.php?q=/modules/'.$_SESSION[$guid]['module'].'/ttDates_edit_delete.php&gibbonSchoolYearID='.$_GET['gibbonSchoolYearID']."&dateStamp=$dateStamp&gibbonTTDayID=".$row['gibbonTTDayID']."'><img title='".__($guid, 'Delete')."' src='./themes/".$_SESSION[$guid]['gibbonThemeName']."/img/garbage.png'/></a> ";
                echo '</td>';
                echo '</tr>';
