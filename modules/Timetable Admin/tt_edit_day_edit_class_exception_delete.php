				...
				if ($result->rowCount()<1) {
					...
					if (!($deleteReturn=="")) {
						if ($deleteReturn=="fail0") {
							...
							$deleteReturnMessage ="Update was successful." ;	
							$class="success" ;
						}
