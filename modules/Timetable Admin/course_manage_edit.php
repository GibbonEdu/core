...
if (isActionAccessible($guid, $connection2, "/modules/Timetable Admin/course_manage_edit.php")==FALSE) {
	...
	if ($gibbonCourseID=="") {
		...
		if ($result->rowCount()!=1) {
			...
			print "<a href='" . $_SESSION[$guid]["absoluteURL"] . "/index.php?q=/modules/" . $_SESSION[$guid]["module"] . "/course_manage_class_add.php&gibbonSchoolYearID=" . $_GET["gibbonSchoolYearID"] . "&gibbonCourseID=$gibbonCourseID'><img title='" . _('Add New Record') . "' src='./themes/" . $_SESSION[$guid]["gibbonThemeName"] . "/img/page_new.png'/></a>" ;
			print "</div>" ;
