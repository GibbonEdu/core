				...
				<table class='smallIntBorder fullWidth' cellspacing='0'>	
					...
					<tr>
						<td> 
							...
							<span class="emphasis small"><?php print __($guid, 'Should this class show in reports?') ?></span>
						</td>
						<td class="right">
							<select name="reportable" id="reportable" class="standardWidth">
								<option <?php if ($row["reportable"]=="Y") {print "selected ";}?>value="Y"><?php print __($guid, 'Yes') ?></option>
								<option <?php if ($row["reportable"]=="N") {print "selected ";}?>value="N"><?php print __($guid, 'No') ?></option>
							</select>
						</td>
					</tr>
					<tr>
