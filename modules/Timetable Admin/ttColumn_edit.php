...
if (isActionAccessible($guid, $connection2, "/modules/Timetable Admin/ttColumn_edit.php")==FALSE) {
	...
	if ($gibbonTTColumnID=="") {
		...
		if ($result->rowCount()!=1) {
			...
			print "<a href='" . $_SESSION[$guid]["absoluteURL"] . "/index.php?q=/modules/" . $_SESSION[$guid]["module"] . "/ttColumn_edit_row_add.php&gibbonSchoolYearID=" . $_GET["gibbonSchoolYearID"] . "&gibbonTTColumnID=$gibbonTTColumnID'><img title='New' src='./themes/" . $_SESSION[$guid]["gibbonThemeName"] . "/img/page_new.gif'/></a>" ;
			print "</div>" ;
