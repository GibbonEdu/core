	...
	if ($currentDate!="") {
		...
		if ($result->rowCount()<1) {
			...
			if ($result->rowCount()<1) {
				...
				print "<a target='_blank' href='" . $_SESSION[$guid]["absoluteURL"] . "/report.php?q=/modules/" . $_SESSION[$guid]["module"] . "/report_studentsNotPresent_byDate_print.php&currentDate=" . dateConvertBack($currentDate) . "'><img title='Print' src='./themes/" . $_SESSION[$guid]["gibbonThemeName"] . "/img/print.png'/></a>" ;
				print "</div>" ;
