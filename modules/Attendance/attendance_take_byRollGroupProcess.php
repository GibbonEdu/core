...
$today=date("Y-m-d");
$URL=$_SESSION[$guid]["absoluteURL"] . "/index.php?q=/modules/" . getModuleName($_POST["address"]) . "/attendance_take_byRollGroup.php&gibbonRollGroupID=$gibbonRollGroupID&currentDate=" . dateConvertBack($currentDate) ;
