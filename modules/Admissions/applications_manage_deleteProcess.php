...
if (isActionAccessible($guid, $connection2, '/modules/Admissions/applications_manage.php') == false) {
    ...
    // Proceed!
    $subGateway = $container->get(AdmissionsApplicationGateway::class);
    $values = $subGateway->getByID($gibbonAdmissionsApplicationID);
    ...
    $deleted = $subGateway->delete($gibbonAdmissionsApplicationID);
