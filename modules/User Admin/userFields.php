...
if (isActionAccessible($guid, $connection2, '/modules/User Admin/userFields.php') == false) {
    ...
    if ($result->rowCount() < 1) {
        ...
        while ($row = $resultPage->fetch()) {
            ...
            echo "<a href='".$_SESSION[$guid]['absoluteURL'].'/index.php?q=/modules/'.$_SESSION[$guid]['module'].'/userFields_delete.php&gibbonPersonFieldID='.$row['gibbonPersonFieldID']."'><img title='".__($guid, 'Delete')."' src='./themes/".$_SESSION[$guid]['gibbonThemeName']."/img/garbage.png'/></a>";
            echo '</td>';
            echo '</tr>';
        }
        echo '</table>';
