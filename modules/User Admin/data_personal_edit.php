			...
			<form method="post" action="<? print $_SESSION[$guid]["absoluteURL"] . "/modules/" . $_SESSION[$guid]["module"] . "/data_personal_editProcess.php?gibbonPersonUpdateID=$gibbonPersonUpdateID" ?>">
				...
				print "<table cellspacing='0' style='width: 100%'>" ;
					...
					print "<tr class='even'>" ;
						...
						print "<td>" ;
							$style="" ;
							if ($row["otherNames"]!=$row["newotherNames"]) {
								$style="style='color: #ff0000'" ;
							}
							print "<span $style>" ;
							print $row["newotherNames"] ;
							print "</span>" ;
						print "</td>" ;
						print "<td>" ;
							if ($row["otherNames"]!=$row["newotherNames"]) { print "<input checked type='checkbox' name='newotherNamesOn'><input name='newotherNames' type='hidden' value='" . htmlprep($row["newotherNames"]) . "'>" ; }
						print "</td>" ;
					print "</tr>" ;
					print "<tr class='odd'>" ;
						print "<td>" ;
