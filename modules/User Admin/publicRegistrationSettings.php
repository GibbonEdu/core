...
if (isActionAccessible($guid, $connection2, "/modules/User Admin/publicRegistrationSettings.php")==FALSE) {
	...
	print "<div class='trailHead'><a href='" . $_SESSION[$guid]["absoluteURL"] . "'>" . _("Home") . "</a> > <a href='" . $_SESSION[$guid]["absoluteURL"] . "/index.php?q=/modules/" . getModuleName($_GET["q"]) . "/" . getModuleEntry($_GET["q"], $connection2, $guid) . "'>" . _(getModuleName($_GET["q"])) . "</a> > </div><div class='trailEnd'>" . _('Public Registration Settings') . "</div>" ;
	print "</div>" ;
	...
	<form method="post" action="<?php print $_SESSION[$guid]["absoluteURL"] . "/modules/" . $_SESSION[$guid]["module"] . "/publicRegistrationSettingsProcess.php" ?>">
		<table class='smallIntBorder' cellspacing='0' style="width: 100%">	
			...
			<tr>
				...
				<td class="right">
					<select name="<?php print $row["name"] ?>" id="<?php print $row["name"] ?>" style="width: 302px">
						<option <?php if ($row["value"]=="Full") {print "selected ";} ?>value="Full"><?php print _('Full') ?></option>
						<option <?php if ($row["value"]=="Pending Approval") {print "selected ";} ?>value="Pending Approval"><?php print _('Pending Approval') ?></option>
					</select>
				</td>
			</tr>
			<tr>
			...
			<tr class='break'>
				<td colspan=2> 
					<h3><?php print _('Interface Options') ?></h3>
				</td>
			</tr>
			<tr>
				<?php
