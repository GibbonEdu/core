...
if (isActionAccessible($guid, $connection2, '/modules/User Admin/user_manage_add.php') == false) {
    ...
    //GS//$nameInCharacters = $_POST['nameInCharacters'] ?? '';
    $nameInCharacters = ''; //GS//
    $gender = $_POST['gender'] ?? '';
    ...
    //Validate Inputs
    //GS//if ($surname == '' or $firstName == '' or $preferredName == '' or $officialName == '' or $gender == '' or $username == '' or $password == '' or $passwordConfirm == '' or $status == '' or $gibbonRoleIDPrimary == '') {
    if ($firstName == '' or $preferredName == '' or $officialName == '' or $gender == '' or $username == '' or $password == '' or $passwordConfirm == '' or $status == '' or $gibbonRoleIDPrimary == '') { //GS//
            $URL .= '&return=error1';
        header("Location: {$URL}");
    } else {
