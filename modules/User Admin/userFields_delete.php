...
if (isActionAccessible($guid, $connection2, "/modules/User Admin/userFields_delete.php")==FALSE) {
	...
	if ($gibbonPersonFieldID=="") {
		...
		if ($result->rowCount()!=1) {
			...
			$row=$result->fetch() ;
			?>
			<form method="post" action="<?php print $_SESSION[$guid]["absoluteURL"] . "/modules/" . $_SESSION[$guid]["module"] . "/userFields_deleteProcess.php?gibbonPersonFieldID=$gibbonPersonFieldID" ?>">
