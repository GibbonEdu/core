...
if (isActionAccessible($guid, $connection2, "/modules/User Admin/data_finance_delete.php")==FALSE) {
	...
	print "<div class='trailHead'><a href='" . $_SESSION[$guid]["absoluteURL"] . "'>" . _("Home") . "</a> > <a href='" . $_SESSION[$guid]["absoluteURL"] . "/index.php?q=/modules/" . getModuleName($_GET["q"]) . "/" . getModuleEntry($_GET["q"], $connection2, $guid) . "'>" . getModuleName($_GET["q"]) . "</a> > <a href='" . $_SESSION[$guid]["absoluteURL"] . "/index.php?q=/modules/User Admin/data_finance.php'>" . _('Finance Data Updates') . "</a> > </div><div class='trailEnd'>" . _('Delete Request') . "</div>" ;
	print "</div>" ;
	...
	if ($gibbonFinanceInvoiceeUpdateID=="") {
		...
		if ($result->rowCount()!=1) {
			...
			$row=$result->fetch() ;
			?>
			<form method="post" action="<? print $_SESSION[$guid]["absoluteURL"] . "/modules/" . $_SESSION[$guid]["module"] . "/data_finance_deleteProcess.php?gibbonFinanceInvoiceeUpdateID=$gibbonFinanceInvoiceeUpdateID" ?>">
				<table class='smallIntBorder' cellspacing='0' style="width: 100%">	
					...
					<tr>
						<td> 
							<input name="gibbonFinanceInvoiceeUpdateID" id="gibbonFinanceInvoiceeUpdateID" value="<? print $gibbonFinanceInvoiceeUpdateID ?>" type="hidden">
