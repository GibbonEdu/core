...
if (isActionAccessible($guid, $connection2, '/modules/User Admin/family_manage_delete.php') == false) {
    ...
    if ($gibbonFamilyID == '') {
        ...
        if ($result->rowCount() != 1) {
            ...
            $form = Form::create('accessRecord', $_SESSION[$guid]['absoluteURL'].'/modules/'.$_SESSION[$guid]['module']."/family_manage_deleteProcess.php?gibbonFamilyID=$gibbonFamilyID&search=$search");
