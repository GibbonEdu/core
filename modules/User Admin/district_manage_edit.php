...
if (isActionAccessible($guid, $connection2, '/modules/User Admin/district_manage_edit.php') == false) {
    ...
    if ($gibbonDistrictID == '') {
        ...
        if ($result->rowCount() != 1) {
            ...
            //Let's go!
            $row = $result->fetch(); ?>
			<form method="post" action="<?php echo $_SESSION[$guid]['absoluteURL'].'/modules/'.$_SESSION[$guid]['module']."/district_manage_editProcess.php?gibbonDistrictID=$gibbonDistrictID" ?>">
