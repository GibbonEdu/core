...
if (isActionAccessible($guid, $connection2, "/modules/User Admin/user_manage_password.php")==FALSE) {
	...
	if (!($updateReturn=="")) {
		if ($updateReturn=="fail0") {
			...
			$updateReturnMessage ="Add failed because the passwords did not match." ;	
		}
		else if ($updateReturn=="fail6") {
			$updateReturnMessage ="Update failed because your password to not meet the minimum requirements for strength." ;	
		}
